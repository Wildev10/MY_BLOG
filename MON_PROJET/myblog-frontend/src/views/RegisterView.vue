      ...
      <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg p-8">
        ...
        <div class="text-center mb-8">
          ...
          <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
            Rejoignez la communaute et partagez vos idees
          </p>
        </div>
        ...
        <form @submit.prevent="handleRegister" class="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              placeholder="••••••••"
            />
            <p class="mt-1 text-xs text-zinc-400">Minimum 8 caracteres</p>
          </div>
        ...
        <div class="mt-6 pt-6 border-t border-zinc-100 dark:border-zinc-800">
          <p class="text-sm text-zinc-500 dark:text-zinc-400 text-center">
            Deja un compte ?
            <router-link to="/login" class="font-medium text-zinc-900 dark:text-zinc-50 hover:underline">
              Se connecter
            </router-link>
          </p>
        </div>
